            ...
            <button
                className={cn(
                    "inline-flex items-center justify-center rounded-full font-medium border backdrop-blur-xl transition-[transform,box-shadow,background-color,border-color,color,opacity] duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-400/50 focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--background)] disabled:opacity-50 disabled:pointer-events-none active:scale-[0.985]",
                    {
                        ...
                        'border-[#EE8D01]/18 bg-[linear-gradient(135deg,#F2AB45,#E59618)] text-white shadow-[0_12px_26px_rgba(238,141,1,0.18)] hover:-translate-y-0.5 hover:shadow-[0_18px_38px_rgba(238,141,1,0.22)] focus-visible:ring-[#EE8D01]/30 dark:border-sky-400/28 dark:bg-[linear-gradient(135deg,#38bdf8,#2563eb)] dark:shadow-[0_18px_40px_rgba(37,99,235,0.24)] dark:focus-visible:ring-sky-400/42': variant === 'brand',
                        'border-[#EE8D01]/18 bg-[#EE8D01]/8 text-[#B86B08] shadow-[0_10px_22px_rgba(238,141,1,0.08)] hover:-translate-y-0.5 hover:border-[#EE8D01]/28 hover:bg-[#EE8D01]/12 hover:text-[#9C5D08] focus-visible:ring-[#EE8D01]/30 dark:border-sky-400/26 dark:bg-sky-400/10 dark:text-sky-200 dark:hover:border-sky-300/34 dark:hover:bg-sky-400/14 dark:hover:text-sky-50 dark:focus-visible:ring-sky-400/42': variant === 'brand-outline',
